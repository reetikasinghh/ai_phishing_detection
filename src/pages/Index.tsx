    ...
    fetch("http://127.0.0.1:5000/analyze", {
      ...
      .then(data => {
        setResult({
          ...
          highlightedEmail: data.highlighted_email,
                ...
                <div className="space-y-6">
                  ...
                  <Tabs defaultValue="warnings">
                    <TabsList className="w-full">
                      ...
                      <TabsTrigger value="safe" className="w-full text-center">
                        Email Analysis</TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="safe" className="w-full col-span-2 mt-2">
                      <div className="w-full rounded-md border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-4">
                    ...
                    {result.highlightedEmail && (
                      <div className="bg-white dark:bg-slate-700 border rounded-md p-4">
                        <h3 className="text-md font-semibold mb-2 text-slate-700 dark:text-white">Highlighted Email:</h3>
                        <div
                          className="prose max-w-none text-sm dark:text-slate-100 break-words overflow-x-auto"
                    ...
                    {result.summary && (
                      <div className="bg-slate-50 dark:bg-slate-800 border rounded-md p-4">
                        <h3 className="text-md font-semibold mb-2 text-slate-700 dark:text-white">Summary:</h3>
                        <pre className="whitespace-pre-wrap break-words text-sm text-left text-slate-700 dark:text-slate-300">
                          {result.summary}
                        </pre>
                      </div>
                    )}
